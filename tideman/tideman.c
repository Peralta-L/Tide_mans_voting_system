...
void add_pairs(void)
{
    ...
    for (int i = 0; i < candidate_count; i++) //candidates loop
    {

        for (int j = i + 1 ; j  < candidate_count; j++) //score loop
        {
...
void lock_pairs(void)
{
    for (int i = 0; i < pair_count; i++)
    {
        ...
        int queue[candidate_count], front = 0, back = 0;
        bool visited[MAX] = {false};

        queue[back++] = pairs[i].loser;
        visited[pairs[i].loser] = true;
